...
class Game:
    def __init__(self):
        ...
        try:
            pygame.mixer.init()
            pygame.mixer.music.load("assets/ambient_chapel.mp3")
            pygame.mixer.music.play(-1)
            self.pickup_sound = pygame.mixer.Sound("assets/pickup.mp3")
            self.unlock_sound = pygame.mixer.Sound("assets/unlock.mp3")
